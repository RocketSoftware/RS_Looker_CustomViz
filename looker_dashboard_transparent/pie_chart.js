 ...
 *   3. In any Explore, select "Rocket — Pie Chart (Transparent)" from the visualization picker.
 *
 * Supports:
...
(function () {
  ...
  const CSS = `
    ...
    @media (prefers-color-scheme: light) {
      .rpc-title,
      .rpc-center-value { color: #1A1A3A; }
      .rpc-subtitle,
      .rpc-center-label-text,
      .rpc-legend-pct,
      .rpc-empty { color: #6060A0; }
    }
