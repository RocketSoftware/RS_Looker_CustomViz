...
(function () {
  ...
  const CSS = `
    ...
    .rhb-leg-item:hover  { background: rgba(123,63,228,.1); }
    .rhb-leg-item.dimmed { opacity: .3; }
    .rhb-leg-item.pinned { background: rgba(123,63,228,.16) !important; }
    ...
    .rhb-leg-name { font-size: 11px; color: #9898C8; white-space: nowrap; }
    ...
    .rhb-gridline  { stroke: rgba(100,100,180,.22); stroke-width: 1; }
    .rhb-zeroline  { stroke: rgba(50,50,120,.20); stroke-width: 1; }
    .rhb-axis-line { stroke: rgba(100,100,180,.32); stroke-width: 1; }
    ...
    .rhb-tt-group  { font-size: 9px; font-weight: 600; text-transform: uppercase; letter-spacing: 1.1px; color: #7878A8; }
    .rhb-tt-label  { font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 1.1px; color: #7878A8; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
    ...
    [data-theme="light"] .rhb-title,
    [data-theme="light"] .rhb-leg-item.pinned .rhb-leg-name { color: #1A1A3A; }
    [data-theme="light"] .rhb-subtitle,
    [data-theme="light"] .rhb-axis-label,
    [data-theme="light"] .rhb-empty { color: #6060A0; }
    [data-theme="light"] .rhb-axis-label { fill: #6060A0; }
