 ...
 *   3. In any Explore, select "Rocket — Single Value (Transparent)" from the visualization picker.
 *
 * Supports:
...
(function () {
  ...
  const CSS = `
    ...
    [data-theme="light"] .sv-suffix,
    [data-theme="light"] .sv-delta-label { color: #6060A0; }
  ...
  looker.plugins.visualizations.add({
    id:    "rocket_single_value_tr",
    label: "Rocket — Single Value (Transparent)",
