 ...
 *   3. Select "Rocket — Bubble Chart (Transparent)" from the visualization picker.
 *
...
(function () {
  ...
  const CSS = `
    ...
    .rbu-axis-line { stroke: rgba(100,100,180,.32); stroke-width: 1; }
    ...
    @media (prefers-color-scheme: light) {
      .rbu-title,
      .rbu-leg-item.pinned .rbu-leg-name { color: #1A1A3A; }
      .rbu-subtitle,
      .rbu-axis-label,
      .rbu-empty { color: #6060A0; }
      .rbu-axis-label { fill: #6060A0; }
    }
