 ...
 *   3. Select "Rocket — Bar Chart (Transparent)" from the visualization picker.
 *
 * Supports:
...
(function () {
  ...
  const CSS = `
    ...
    .rbc-leg-item:hover  { background: rgba(123,63,228,.1); }
    ...
    .rbc-gridline { stroke: rgba(100,100,180,.22); stroke-width: 1; }
    .rbc-axis-line { stroke: rgba(100,100,180,.32); stroke-width: 1; }
    ...
    [data-theme="light"] .rbc-title,
    [data-theme="light"] .rbc-leg-item.pinned .rbc-leg-name { color: #1A1A3A; }
    [data-theme="light"] .rbc-subtitle,
    [data-theme="light"] .rbc-axis-label,
    [data-theme="light"] .rbc-empty { color: #6060A0; }
    [data-theme="light"] .rbc-axis-label { fill: #6060A0; }
