...
(function () {
  ...
  const CSS = `
    ...
    .rhb-leg-item:hover  { background: rgba(123,63,228,.10); }
    ...
    .rhb-gridline  { stroke: rgba(120,120,175,.22); stroke-width: 1; }
    .rhb-zeroline  { stroke: rgba(50,50,120,.20); stroke-width: 1; }
    .rhb-axis-line { stroke: rgba(100,100,160,.32); stroke-width: 1; }
