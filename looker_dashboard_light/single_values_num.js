...
(function () {
  ...
  const CSS = `
    ...
    .sv-root[data-h="xs"] .sv-value          { font-size: 24px; }
    .sv-root[data-h="xs"] .sv-prefix,
    .sv-root[data-h="xs"] .sv-suffix         { font-size: 13px; }
    ...
    .sv-root[data-h="sm"] .sv-value          { font-size: 28px; }
    .sv-root[data-h="sm"] .sv-prefix,
    .sv-root[data-h="sm"] .sv-suffix         { font-size: 15px; }
  ...
  looker.plugins.visualizations.add({
    ...
    updateAsync: function (data, element, config, queryResponse, details, done) {
      ...
      /* Strip uses the same gradient rotated to vertical */
