 ...
 *   3. Select "Rocket — Gauge (Light)" from the visualization picker.
 *
 * Supports:
...
(function () {
  ...
  looker.plugins.visualizations.add({
    id:    "rocket_gauge_light",
    label: "Rocket — Gauge (Light)",
