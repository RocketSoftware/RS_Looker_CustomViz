 ...
 *   3. Select "Rocket — Bubble Chart" from the visualization picker.
 *
...
(function () {
  ...
  const CSS = `
    ...
    .rbu-leg-item:hover  { background: rgba(123,63,228,.1); }
    .rbu-leg-item.dimmed { opacity: .3; }
    .rbu-leg-item.pinned { background: rgba(123,63,228,.22) !important; }
    ...
    .rbu-axis-line { stroke: rgba(89,89,133,.35); stroke-width: 1; }
  ...
  looker.plugins.visualizations.add({
    id:    "rocket_bubble_chart",
    label: "Rocket — Bubble Chart",
