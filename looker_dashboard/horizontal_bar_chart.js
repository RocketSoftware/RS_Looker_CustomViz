...
(function () {
  ...
  const CSS = `
    ...
    .rhb-leg-item.pinned { background: rgba(123,63,228,.22) !important; }
    ...
    .rhb-gridline  { stroke: rgba(89,89,133,.22); stroke-width: 1; }
    .rhb-zeroline  { stroke: rgba(226,226,255,.3); stroke-width: 1; }
    .rhb-axis-line { stroke: rgba(89,89,133,.35); stroke-width: 1; }
    ...
    .rhb-tooltip {
      ...
      box-shadow: 0 8px 32px rgba(0,0,0,.65), 0 0 0 1px rgba(123,63,228,.08);
