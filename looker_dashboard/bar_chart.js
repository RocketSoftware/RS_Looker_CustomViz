 ...
 *   3. Select "Rocket — Bar Chart" from the visualization picker.
 *
 * Supports:
...
(function () {
  ...
  const CSS = `
    ...
    .rbc-leg-item.pinned { background: rgba(123,63,228,.22) !important; }
    ...
    .rbc-gridline { stroke: rgba(89,89,133,.22); stroke-width: 1; }
    .rbc-axis-line { stroke: rgba(89,89,133,.35); stroke-width: 1; }
